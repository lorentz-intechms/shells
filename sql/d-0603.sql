-- SELECT CONCAT('sudo node bin/main.js NonethM3u8Command --app_id=4 --id=', ap.id, ' --url="https://nl4cgvem.xwzh022.com/', ausa.key, '" --filename="', ap.name, '" --algorithm="aes-128-ecb" --key="saIZXc4yMvq0Iz56";  # video_bit_rate=', ap.video_bit_rate, '  ,resolution=', ap.width, '_', ap.height) 
